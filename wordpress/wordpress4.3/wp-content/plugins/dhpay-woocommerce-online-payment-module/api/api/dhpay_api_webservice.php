...
// Include API base 
require_once(DIR . DS . "dhpay_api_base.php");
require_once(DIR . DS . "dhpay_api_order.php");

/**
 * @package API_Webservice
 */
class Dhpay_Api_Webservice extends Dhpay_Api_Base {
    ...
    public function autoCaptureService()
    {
        if (!$this->_service_autoCapture)
            $this->_service_autoCapture = new Dhpay_Webservice_AutoCapture();
    ...
    public function paymentMethodService()
    {
        if (!$this->_service_paymentMethods)
            $this->_service_paymentMethods = new Dhpay_Webservice_Paymentmethods();
    ...
    {
        if (!$this->_filtering)
            $this->_filtering = new Dhpay_Webservice_Filtering();
    ...
    {
        if (!$this->_single)
            $this->_single = new Dhpay_Webservice_Paymentmethod();
        return $this->_single;
    }
    ...
    public function paymentService()
    {
        if (!$this->_service_pay)
            $this->_service_pay = new Dhpay_Webservice_Pay();
    ...
    public function reportingService()
    {
        if (!$this->_service_reporting)
            $this->_service_reporting = new Dhpay_Webservice_Reporting();
    ...
    public function refundService()
    {
        if (!$this->_service_refunds)
            $this->_service_refunds = new Dhpay_Webservice_Refunds();
 ...
 * @package API_Webservice
 */
class Dhpay_Webservice_Base extends Dhpay_Api_Base {

    protected $service = 'https://connect.dhpay.com/webservice/dhpay.svc?wsdl';
    protected $client;
 ...
 */
class Dhpay_Webservice_Paymentmethods extends Dhpay_Webservice_Base {
     ...
     * @access public
     * 
     * @return \Dhpay_Webservice_Paymentmethods
     */
 ...
 */
class Dhpay_Webservice_Filtering {
     ...
     * @access public
     * @param string $string
     * @return \Dhpay_Webservice_Filtering
     */
 ...
 */
class Dhpay_Webservice_Paymentmethod extends Dhpay_Webservice_Filtering {
     ...
     * @access public
     * @param string $name
     * @return \Dhpay_Webservice_Paymentmethod
     * @throws Exception 
     */
 ...
 */
class Dhpay_Webservice_Pay extends Dhpay_Webservice_Base {
    ...
    public function extendedCheckout(Dhpay_PaymentObject_Interface_Abstract $paymentObj, $getUrlOnly = false)
    {
        $obj = new stdClass();

        Dhpay_Order::getInstance()->validateOrder($paymentObj);
        ...
        $obj->XML = Dhpay_Order::getInstance()->createXML();
        ...
        $transactionObj = new Dhpay_TransactionObject();
    ...
    public function autoCheckout(Dhpay_PaymentObject_Interface_Abstract $paymentObj, $consumerID)
    {
        $obj = new StdClass();
    ...
    public function vaultCheckout(Dhpay_PaymentObject_Interface_Abstract $paymentObj, $consumerID, $getUrlOnly = false)
    {
        $obj = new StdClass();
    ...
    /**
     * The Checkout web method allows you to  initialize a new payment in the DHPAY system for  ALL the
     * payment methods that you have access to
     * 
     * @since version 2.1.0
     * @access public
     * @param Dhpay_PaymentObject_Interface_Abstract $paymentObj
     * @param bool $geturlOnly
     * @return array result
     */
    public function checkOut(Dhpay_PaymentObject_Interface_Abstract $paymentObj, $getUrlOnly = false)
    {
        $obj = new stdClass();
    ...
    /**
     * The PhoneCheckout web method  allows you to create a phone payment in the DHPAY system. The
     ...
     * @return array result
     */
    public function phoneCheckout(Dhpay_PaymentObject_Interface_Abstract $paymentObj, $getUrlOnly = false)
    {
        $obj = new StdClass();
    ...
    /**
     * The SmsCheckout web method allows you to create an SMS payment in the DHPAY system. The main
     ...
     * @return array
     */
    public function smsCheckout(Dhpay_PaymentObject_Interface_Abstract $paymentObj, $getUrlOnly = false)
    {
        $obj = new StdClass();
    ...
    /**
     * The phoneDirectCheckout web method allows you to initialize a new payment in the DHPAY system
     ...
     * @return array result
     */
    public function phoneDirectCheckout(Dhpay_PaymentObject_Interface_Abstract $paymentObj)
    {
        $obj = new StdClass();
 ...
 */
class Dhpay_Webservice_Refunds extends Dhpay_Webservice_Base {

    protected $service = 'https://connect.dhpay.com/webservice/refund.svc?wsdl';
 ...
 */
class Dhpay_Webservice_Reporting extends Dhpay_Webservice_Base {

    protected $service = 'https://connect.dhpay.com/webservice/report.svc?wsdl';
    protected $_autokill = false;
    protected $_sessionName = "dhpay_api_webservice_reportingsession";
    protected $_session;
    protected $_username;
    ...
    {
        setcookie("dhpay_api_webservice_reportingsession_SessionID", '', time() - 1000);
        setcookie("dhpay_api_webservice_reportingsession_Timestamp", '', time() - 1000);
    }
    ...
    public function setSessionName($name = "dhpay_api_webservice_reportingsession")
    {
    ...
    /**
     * The getMerchant web method returns a list of merchants that belong to your DHPAY account.
     * 
     * @since version 2.1.0
     * @access public
     * @return array
    ...
    /**
     * The getPaymentMethods web method returns a list of  all  supported payment methods by DHPAY.
     * 
     * @since version 2.1.0
     * @access public
     */
    ...
    /**
     * The searchPayments web method allows you to search for payments linked to your DHPAY account. There are
...
/**
 * Dhpay AutoCapture Webservice class
 * 
 * @version 1.0.0
 * @author Wouter van Tilburg <wouter@dhpay.eu>
 * @copyright Copyright (c) 2012, DHPAY
 */
class Dhpay_Webservice_AutoCapture extends Dhpay_Webservice_Base {

    protected $service = 'https://connect.dhpay.com/webservice/APCapture.svc?wsdl';
