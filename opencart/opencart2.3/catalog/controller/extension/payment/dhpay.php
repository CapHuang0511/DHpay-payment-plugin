...
class ControllerExtensionPaymentDhpay extends Controller{
    ...
    public function index()
    {
        ...
        $this->load->model('extension/payment/dhpay');
        ...
        $this->model_extension_payment_dhpay->initConfig();

        $data['dhpay_params'] = array(
            ...
            'return_url'=>HTTPS_SERVER . 'index.php?route=extension/payment/dhpay/ipn&dh_rt=real_time',
            'remark'=>'',
        ...
        if (file_exists(DIR_APPLICATION . 'view/theme/' . $this->config->get('config_template') . '/extension/payment/dhpay.tpl')) {
            return $this->load->view(DIR_APPLICATION . 'view/theme/' . $this->config->get('config_template') . '/extension/payment/dhpay.tpl', $data);
        } else {
            return $this->load->view('extension/payment/dhpay.tpl', $data);
        }
    ...
    public function ipn()
    {
        ...
        $this->model_extension_payment_dhpay->ipn($this->request->get);
    }
